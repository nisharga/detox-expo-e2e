...
module.exports = {
  ...
  apps: {
    ...
    "android.debug": {
      ...
      build:
        "cd android && call gradlew.bat assembleDebug assembleAndroidTest -DtestBuildType=debug",
    ...
    "android.release": {
      ...
      build:
        "cd android && call gradlew.bat assembleRelease assembleAndroidTest -DtestBuildType=release",
